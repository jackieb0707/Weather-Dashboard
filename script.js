...
function currentCondition(city) {
    ...
    $.ajax({
        ...
        var uviQueryURL = `https://api.openweathermap.org/data/2.5/uvi?lat=${lat}&lon=${ion}&appid=${apikey}`;
...
function futureCondition(lat, ion) {
    ...
    $.ajax({
        ...
        for (let i = 1; i < 6; i++) {
            var cityInfo = {
                ...
                humidity: futureResponse.daily[i].hum
            };
